...
function AuthForm() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex flex-col relative isolate overflow-hidden">
      <BackgroundDecor />
      ...
      <main style={{flex:1,display:'flex',alignItems:'center',justifyContent:'center',padding:'6rem 1.5rem 3rem',position:'relative',zIndex:10}}>
        <div style={{width:'100%',maxWidth:'420px'}}>
          ...
          {/* Role switcher */}
          <div className="anim-fade-up delay-100 panel-interactive" style={{display:'flex',background:'#141414',borderRadius:'9999px',padding:'0.3rem',gap:'0.25rem',marginBottom:'1.5rem'}}>
          ...
          <form onSubmit={submit} className="anim-fade-up delay-200 panel-interactive" style={{background:'#111',borderRadius:'1.25rem',padding:'2rem',display:'flex',flexDirection:'column',gap:'1.25rem'}}>
            {role === 'candidate' ? (
