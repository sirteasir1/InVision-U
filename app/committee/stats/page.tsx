...
function StatCard({ label, value, sub, accent = false }: { label: string; value: string | number; sub?: string; accent?: boolean }) {
  return (
    <div className="bg-surface-container-low rounded-xl p-7 space-y-1">
  ...
  return (
    <div className="px-4 md:px-10 pb-16 max-w-[1440px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-surface-container-low rounded-xl p-7 space-y-5">
        ...
        <div className="bg-surface-container-low rounded-xl p-7 space-y-5">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={row.label} className={`flex items-center justify-between ${row.color} rounded-xl px-5 py-4`}>
        ...
        <div className="md:col-span-2 bg-surface-container-low rounded-xl p-7 space-y-5">
          <div className="flex items-center gap-2">
          ...
          {withScores.length === 0 ? (
            ...
            <div className="space-y-2">
              {[...withScores]
                ...
                .slice(0, 5)
                .map((c, i) => (
                  <div key={c.id} className="flex items-center gap-4 bg-surface-container rounded-xl px-5 py-4">
