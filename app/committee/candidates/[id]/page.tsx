...
function Card({ title, icon, children }: { title: string; icon: string; children: ReactNode }) {
  return (
    <div className="panel-soft rounded-[24px] p-6 md:p-8 space-y-5">
...
export default function CandidateDetailPage() {
  ...
  const essayReview = s?.essay_review || FALLBACK_TEXT_REVIEWS.essay_review
  const interviewReview = s?.interview_review || FALLBACK_TEXT_REVIEWS.interview_review
  ...
  return (
    <div className="px-4 md:px-10 pb-16 max-w-5xl mx-auto">
      ...
      <div className="space-y-5">
        <div className="flex items-start gap-3 panel-soft rounded-[24px] p-5">
        ...
        {!s ? (
          <div className="panel-soft rounded-[24px] p-16 text-center space-y-4">
            {c.status === 'error' ? (
              <>
          ...
          <>
            <div className="panel-soft rounded-[24px] p-8 md:p-10 space-y-6">
              ...
              <div className="bg-surface-container-high rounded-[20px] p-5">
              ...
              <Card title="Сильные стороны" icon="thumb_up">
                <div className="space-y-2">
                  {s.strengths.map((item, i) => (
                    <div key={i} className="flex items-start gap-3 bg-surface-container-high rounded-[20px] p-4">
              ...
              <Card title="Расхождения между эссе и интервью" icon="compare_arrows">
                <div className="space-y-2">
                  {s.contradictions.map((con, i) => (
                    <div key={i} className="flex items-start gap-3 bg-surface-container-high p-4 rounded-[20px]">
              ...
              <Card title="Текстовые основания" icon="format_quote">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {Object.entries(s.evidence).map(([key, val]) => (
                    <div key={key} className="bg-surface-container-high rounded-[20px] p-5 space-y-2">
            ...
            <Card title="Разбор эссе и интервью" icon="subject">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-surface-container-high rounded-[20px] p-5">
                  <p className="text-primary-container text-xs font-label font-bold uppercase tracking-widest mb-2">Эссе</p>
                  <p className="text-on-surface-variant text-sm font-label leading-relaxed">{essayReview}</p>
                </div>
                <div className="bg-surface-container-high rounded-[20px] p-5">
                  <p className="text-primary-container text-xs font-label font-bold uppercase tracking-widest mb-2">Интервью</p>
                  <p className="text-on-surface-variant text-sm font-label leading-relaxed">{interviewReview}</p>
                </div>
              </div>
            </Card>
            ...
            <Card title="Эссе" icon="article">
              ...
              {showEssay && <div className="bg-surface-container-high rounded-[20px] p-6 text-on-surface-variant text-sm font-label leading-relaxed whitespace-pre-wrap">{c.essay}</div>}
            </Card>
            ...
            <Card title="Ответы интервью" icon="forum">
              ...
              {showIV && <div className="bg-surface-container-high rounded-[20px] p-6 text-on-surface-variant text-sm font-label leading-relaxed whitespace-pre-wrap">{c.interview_text}</div>}
            </Card>
